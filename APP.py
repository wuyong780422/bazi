...
div.block-container {padding-top: 50px !important;padding-left:20px !important;padding-right:20px !important;padding-bottom:100px !important;}
...
with tab1:
    # UTC时区+8小时 转为北京时间，修复日期偏差
    now_bj = datetime.now(timezone.utc) + timedelta(hours=8)
    d = st.date_input("选择日期", now_bj, min_value=datetime(1900, 1, 1), max_value=datetime(2100, 12, 31))
...
with tab10:
    ...
    st.markdown("""
### 一、开发作者简介
吴勇，太平村兴兴台人，计算机网络高级工程师、网络信息安全高级技师、省级名师工作室成员、省级优秀指导教师、高级双师型教师、高级讲师。爱好计算机编程与传统文化数字化领域，擅长将正统民俗命理逻辑与软件工程规范结合，打造严谨、稳定、易用的命理工具系统。
### 二、真命盘系统介绍
    ...
    if check_mode == "验证*公历吉日":
        ...
        if st.button("✅ 开始验证吉日", use_container_width=True):
            with st.spinner("正在验证中..."):
                ...
                # 太阳时辰对照表，和sun_star_table一一对应
                sun_time_table = {
                    "甲子": ("未", "13:00-15:00"), "乙丑": ("申", "15:00-17:00"), "丙寅": ("辰", "07:00-09:00"),
                    "丁卯": ("申", "15:00-17:00"),
                    "戊辰": ("卯", "05:00-07:00"), "己巳": ("未", "13:00-15:00"), "庚午": ("申", "15:00-17:00"),
                    "辛未": ("辰", "07:00-09:00"),
                    "壬申": ("申", "15:00-17:00"), "癸酉": ("卯", "05:00-07:00"), "甲戌": ("未", "13:00-15:00"),
                    "乙亥": ("申", "15:00-17:00"),
                    "丙子": ("辰", "07:00-09:00"), "丁丑": ("申", "15:00-17:00"), "戊寅": ("卯", "05:00-07:00"),
                    "己卯": ("未", "13:00-15:00"),
                    "庚辰": ("申", "15:00-17:00"), "辛巳": ("辰", "07:00-09:00"), "壬午": ("申", "15:00-17:00"),
                    "癸未": ("卯", "05:00-07:00"),
                    "甲申": ("未", "13:00-15:00"), "乙酉": ("申", "15:00-17:00"), "丙戌": ("辰", "07:00-09:00"),
                    "丁亥": ("申", "15:00-17:00"),
                    "戊子": ("卯", "05:00-07:00"), "己丑": ("未", "13:00-15:00"), "庚寅": ("申", "15:00-17:00"),
                    "辛卯": ("辰", "07:00-09:00"),
                    "壬辰": ("申", "15:00-17:00"), "癸巳": ("卯", "05:00-07:00"), "甲午": ("未", "13:00-15:00"),
                    "乙未": ("申", "15:00-17:00"),
                    "丙申": ("辰", "07:00-09:00"), "丁酉": ("申", "15:00-17:00"), "戊戌": ("卯", "05:00-07:00"),
                    "己亥": ("未", "13:00-15:00"),
                    "庚子": ("申", "15:00-17:00"), "辛丑": ("辰", "07:00-09:00"), "壬寅": ("申", "15:00-17:00"),
                    "癸卯": ("卯", "05:00-07:00"),
                    "甲辰": ("未", "13:00-15:00"), "乙巳": ("申", "15:00-17:00"), "丙午": ("辰", "07:00-09:00"),
                    "丁未": ("申", "15:00-17:00"),
                    "戊申": ("卯", "05:00-07:00"), "己酉": ("未", "13:00-15:00"), "庚戌": ("申", "15:00-17:00"),
                    "辛亥": ("辰", "07:00-09:00"),
                    "壬子": ("申", "15:00-17:00"), "癸丑": ("卯", "05:00-07:00"), "甲寅": ("未", "13:00-15:00"),
                    "乙卯": ("申", "15:00-17:00"),
                    "丙辰": ("辰", "07:00-09:00"), "丁巳": ("申", "15:00-17:00"), "戊午": ("卯", "05:00-07:00"),
                    "己未": ("未", "13:00-15:00"),
                    "庚申": ("申", "15:00-17:00"), "辛酉": ("辰", "07:00-09:00"), "壬戌": ("申", "15:00-17:00"),
                    "癸亥": ("卯", "05:00-07:00"),
                }
...
if st.session_state.bottom_nav_active != "风水":
    ...
    st.markdown("<div style='text-align:center; margin-top:20px;'><h3>🧭 民俗风水·专属</h3></div>", unsafe_allow_html=True)
    if "bazi_result" not in st.session_state or not st.session_state.bazi_result:
...
"""
                    ...
                    response = client.chat.completions.create(
                        model="ep-m-20260204112644-t9jzd",
        ...
        if "ai_result" in st.session_state and st.session_state.ai_result:
            ...
            if DOCX_AVAILABLE:
                ...
                word_bytes = generate_word_doc(bazi_data, gender, st.session_state.ai_result, st.session_state.get("fengshui_result", ""))
                st.download_button(
                    label="📄 导出Word",
                    data=word_bytes,
                    file_name=file_name,
                ...
                st.button("📄 导出Word（未安装python-docx）", disabled=True, use_container_width=True)# ========= 【底部固定悬浮导航栏】只负责跟随状态变色，纯视觉层 =========
