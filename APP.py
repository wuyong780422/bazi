...
# 顶部标题栏（保留原样式：左微信图标 + 中标题 + 右…）
st.markdown("""
<div class="fixed-header">
    <span class="header-icon" onclick="document.getElementById('wechat-modal').style.display='flex'">
        <svg width="38" height="38" viewBox="0 0 24 24" fill="#07C160">
