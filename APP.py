...
# ==============================================
sun_star_table = {
    "甲子": ([6,15,24],"未"),"乙丑": ([1,10,19,28],"申"),"丙寅": ([7,16,25],"酉"),"丁卯": ([2,11,20,29],"戌"),
    "戊辰": ([3,12,21,30],"亥"),"己巳": ([4,13,22],"子"),"庚午": ([5,14,23],"丑"),"辛未": ([6,15,24],"寅"),
    "壬申": ([1,10,19,28],"卯"),"癸酉": ([7,16,25],"辰"),"甲戌": ([2,11,20,29],"巳"),"乙亥": ([3,12,21,30],"午"),
    "丙子": ([4,13,22],"未"),"丁丑": ([5,14,23],"申"),"戊寅": ([6,15,24],"酉"),"己卯": ([1,10,19,28],"戌"),
    "庚辰": ([7,16,25],"亥"),"辛巳": ([2,11,20,29],"子"),"壬午": ([3,12,21,30],"丑"),"癸未": ([4,13,22],"寅"),
    "甲申": ([5,14,23],"卯"),"乙酉": ([6,15,24],"辰"),"丙戌": ([1,10,19,28],"巳"),"丁亥": ([7,16,25],"午"),
    "戊子": ([2,11,20,29],"未"),"己丑": ([3,12,21,30],"申"),"庚寅": ([4,13,22],"酉"),"辛卯": ([5,14,23],"戌"),
    "壬辰": ([6,15,24],"亥"),"癸巳": ([1,10,19,28],"子"),"甲午": ([7,16,25],"丑"),"乙未": ([2,11,20,29],"寅"),
    "丙申": ([3,12,21,30],"卯"),"丁酉": ([4,13,22],"辰"),"戊戌": ([5,14,23],"巳"),"己亥": ([6,15,24],"午"),
    "庚子": ([1,10,19,28],"未"),"辛丑": ([7,16,25],"申"),"壬寅": ([2,11,20,29],"酉"),"癸卯": ([3,12,21,30],"戌"),
    "甲辰": ([4,13,22],"亥"),"乙巳": ([5,14,23],"子"),"丙午": ([6,15,24],"丑"),"丁未": ([1,10,19,28],"寅"),
    "戊申": ([7,16,25],"卯"),"己酉": ([2,11,20,29],"辰"),"庚戌": ([3,12,21,30],"巳"),"辛亥": ([4,13,22],"午"),
    "壬子": ([5,14,23],"未"),"癸丑": ([6,15,24],"申"),"甲寅": ([1,10,19,28],"酉"),"乙卯": ([7,16,25],"戌"),
    "丙辰": ([2,11,20,29],"亥"),"丁巳": ([3,12,21,30],"子"),"戊午": ([4,13,22],"丑"),"己未": ([5,14,23],"寅"),
    "庚申": ([6,15,24],"卯"),"辛酉": ([1,10,19,28],"辰"),"壬戌": ([7,16,25],"巳"),"癸亥": ([2,11,20,29],"午"),
}
