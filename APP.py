        ...
        if st.button("🔍 查询5年吉日", use_container_width=True):
            with st.spinner("择日中..."):
                ...
                for i in range(1, 1826):
                    ...
                    # 8. 拼接显示文本（电脑版原版格式）
                    peng = {"甲":"不开仓","乙":"不栽植","丙":"不修灶","丁":"不剃头","戊":"不受田","己":"不破券","庚":"不安床","辛":"不合酱","壬":"不祷神"}.get(day_gan, "")
