...
s4 = "color:#D4AF37;font-weight:bold;" if act=="取名" else "color:#555;"
s5 = "color:#D4AF37;font-weight:bold;" if act=="解读" else "color:#555;"
...
<div class="bottom-fixed-nav">
    ...
    <div class="nav-item" style="{s4}">🎯<br>取名</div>
    <div class="nav-item" style="{s5}">📄<br>解读</div>
